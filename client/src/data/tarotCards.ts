import { TarotCardTypes } from "../types";

export const tarotCards: TarotCardTypes[] = [
  {
    card_name: "The Fool",
    meanings: {
      upright:
    ...
    number: 0,
    card_links: "None and all of the other major arcana cards.",
    astrological_sign: "Uranus",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Fool_(tarot_card)",
  },
  {
    ...
    number: 1,
    card_links: "X The Wheel of Fortune and XIX The Sun.",
    astrological_sign: "Mercury",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Magician_(tarot_card)",
  },
  {
    ...
    astrological_sign: "The Moon",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_High_Priestess",
  },
  {
    ...
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Empress_(tarot_card)",
  },
  {
    ...
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Emperor_(tarot_card)",
  },
  {
    ...
    number: 5,
    card_links: "XIV Temperance",
    astrological_sign: "Taurus",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Hierophant",
  },
  {
    ...
    number: 6,
    card_links: "XV The Devil",
    astrological_sign: "Gemini",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Lovers",
  },
  {
    ...
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Chariot_(tarot_card)",
  },
  {
    card_name: "Strength",
    meanings: {
    ...
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Strength_(tarot_card)",
  },
  {
    ...
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Hermit_(tarot_card)",
  },
  {
    card_name: "Wheel of Fortune",
    meanings: {
      upright:
        "The Wheel of Fortune means a change for the better. It's also a card of good fortune, so be ready to be open and receive what you need. This card is associated with money luck as well.",
      reversed:
        "When reversed, the Wheel shows the end of a cycle. A further meaning is delay and feeling disconnected; trust your inner knowing.",
    },
    number: 10,
    card_links: "I The Magician and XIX The Sun",
  ...
  },
  {
    ...
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Justice_(tarot_card)",
  },
  {
    ...
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Hanged_Man_(tarot_card)",
  },
  {
    card_name: "Death",
    meanings: {
    ...
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Death_(tarot_card)",
  },
  {
  ...
  },
  {
    ...
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Devil_(tarot_card)",
  },
  {
    card_name: "The Tower",
    meanings: {
    ...
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Tower_(tarot_card)",
  },
  {
    card_name: "The Star",
    meanings: {
    ...
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Star_(tarot_card)",
  },
  {
    card_name: "The Moon",
    meanings: {
    ...
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_Moon_(tarot_card)",
  },
  {
    card_name: "The Sun",
    meanings: {
  ...
  },
  {
    ...
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Judgement_(tarot_card)",
  },
  {
    card_name: "The World",
    meanings: {
    ...
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/The_World_(tarot_card)",
  },
  {
    ...
    astrological_sign: "All water signs: Cancer, Scorpio, and Pisces",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ace_of_Cups",
  },
  {
    card_name: "Two of Cups",
    meanings: {
      upright:
        "This is a card of love and harmony, which extends to all forms of relationships. It favors partnerships, so new love grows and in existing relationships there is more commitment. A further meaning is forgiveness and reconciliation so past hurts are healed.",
      reversed:
        "When reversed, the card shows a relationship under stress or on hold. There may be practical reasoning for this, but if not, let your intuition speak: follow the thread.",
    },
    number: 2,
    card_links: "The Lovers",
    astrological_sign: "Venus in Cancer",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Two_of_Cups",
  },
  {
    card_name: "Three of Cups",
    meanings: {
      upright:
        "This is the celebration card of the tarot, bringing happy occasions, reunions, and new people into your life: you reignite friendships and form new understanding romantic relationships.",
      reversed:
        "When reversed, the card reveals imbalance, which can manifest as overindulgence or inappropriate responses. This may mean distance in some relationships and too much intensity in others.",
    },
    number: 3,
    card_links: null,
    astrological_sign: "Mercury in Cancer",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Three_of_Cups",
  },
  {
    card_name: "Four of Cups",
    meanings: {
      upright:
        "This Four is the card of despondency. It shows flat situations and boredom, particularly in love and work. If a relationship has become stuck, it is time to try new ways forward. Take a risk and do not be worn down by disappointment.",
      reversed:
        "The upright meaning becomes acute in the reversed card, so there is even more need to be open to change and create your own opportunities.",
    },
    number: 4,
    card_links: "Ace of Cups",
    astrological_sign: "Moon in Cancer",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Four_of_Cups",
  },
  {
    ...
    number: 5,
    card_links: null,
    astrological_sign: "Mars in Scorpio",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Five_of_Cups",
  },
  {
    card_name: "Six of Cups",
    meanings: {
      upright:
        "This is a happy time of reconnection and memories as you reminisce about the past or meet up with old friends and family in person. This reaffirms your bond bringing peace and sweetness into your life.",
      reversed:
        "The reversed card can reveal sentimentality and living too much in the past to avoid current challenges.",
    },
    number: 6,
    card_links: null,
    astrological_sign: "Sun in Scorpio",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Six_of_Cups",
  },
  {
    card_name: "Seven of Cups",
    meanings: {
      upright:
        "This Seven is the card of confusion, delusion, and choices. Positively, a situation or relationship has potential, but these are early days. And, while wild ideas might be captivating, what you contemplate may not materialize.",
      reversed:
        "The reversed card can reveal obsessions, avoidance of the facts, and potential deception, particularly in romantic relationships",
    },
    number: 7,
    card_links: null,
    astrological_sign: "Venus in Scorpio",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Seven_of_Cups",
  },
  {
    card_name: "Eight of Cups",
    meanings: {
      upright:
        "This card reveals a change of heart. You may no longer want what you have so you need to move on. You must let go of something or someone who was emotionally important but no longer has any value.",
      reversed:
        "When reversed, the meaning can indicate a situation ending before you are ready or denial and attempts at bargaining for something that is already lost.",
    },
    number: 8,
    card_links: null,
    astrological_sign: "Saturn in Pisces",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Eight_of_Cups",
  },
  {
    card_name: "Nine of Cups",
    meanings: {
      upright:
        "One of the happiest cards in the deck. This card brings joy, abundance, and connection. This is the time to appreciate and share what you have and manifest more of what you desire.",
      reversed:
        "When reversed, there is much ego on show and you may be dealing with arrogance.",
    },
    number: 9,
    card_links: null,
    astrological_sign: "Jupiter in Pisces",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Nine_of_Cups",
  },
  {
    card_name: "Ten of Cups",
    meanings: {
      upright:
        "The Ten is the ultimate expression of love, stability, and positivity. The card brings harmony in relationships and stronger family bonds.",
      reversed:
        "When reversed, the cards meaning is largely positive but there may be unsettling changes in family dynamics and friendships.",
    },
    number: 10,
    card_links: null,
    astrological_sign: "Mars in Pisces",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ten_of_Cups",
  },
  {
    ...
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Page_of_Cups",
  },
  {
  ...
  },
  {
    ...
    number: null,
    card_links: "III The Empress",
    astrological_sign: "Gemini and Cancer",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/Queen_of_Cups",
  },
  {
    ...
    number: null,
    card_links: "IV The Emperor",
    astrological_sign: "Libra and Scorpio",
    element: "Water",
    wikipedia_link: "https://en.wikipedia.org/wiki/King_of_Cups",
  },
  {
    ...
    number: 1,
    card_links: "I The Magician",
    astrological_sign: "Taurus, Virgo, and Capricorn",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ace_of_Coins",
  },
  {
    ...
    number: 2,
    card_links: null,
    astrological_sign: "Jupiter in Capricorn",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Two_of_Coins",
  },
  {
    ...
    number: 3,
    card_links: null,
    astrological_sign: "Mars in Capricorn",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Three_of_Coins",
  },
  {
    ...
    number: 4,
    card_links: null,
    astrological_sign: "Sun in Capricorn",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Four_of_Coins",
  },
  {
    ...
    number: 5,
    card_links: null,
    astrological_sign: "Mercury in Taurus",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Five_of_Coins",
  },
  {
    card_name: "Six of Pentacles",
    meanings: {
      upright:
        "This card indicates shared wealth and a valued role in community. You may be the one giving to others or may be the lucky recipient. This card also represents donations, charity work and gifts.",
      reversed:
        "The reversed card shows money running through your fingers. A gift may be squandered or otherwise used unwisely.",
    },
    number: 6,
    card_links: "V The Hierophant",
    astrological_sign: "Moon in Taurus",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Six_of_Coins",
  },
  {
    ...
    number: 7,
    card_links: null,
    astrological_sign: "Saturn in Taurus",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Seven_of_Coins",
  },
  {
    card_name: "Eight of Pentacles",
    meanings: {
      upright:
        "Your commitment and skill bring rewards as money comes in and you gain ground in your career. Continue to use your skill and experience to improve your financial status and your security.",
      reversed:
        "Feeling trapped in a routine that doesn't serve you, money may be the only consolation. It may be time to embrace a new cycle and brighter opportunities.",
    },
    number: 8,
    card_links: null,
    astrological_sign: "Sun in Virgo",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Eight_of_Coins",
  },
  {
    ...
    astrological_sign: "Sun in Virgo",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Nine_of_Coins",
  },
  {
    ...
    number: 10,
    card_links: null,
    astrological_sign: "Mercury in Virgo",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ten_of_Coins",
  },
  {
    ...
    astrological_sign: null,
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Page_of_Coins",
  },
  {
    ...
    number: null,
    card_links: "VII The Chariot",
    astrological_sign: "Leo and Virgo",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Knight_of_Coins",
  },
  {
    ...
    number: null,
    card_links: "III The Empress",
    astrological_sign: "Sagittarius and Capricorn",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/Queen_of_Coins",
  },
  {
    ...
    number: null,
    card_links: "IV The Emperor",
    astrological_sign: "Aries and Taurus",
    element: "Earth",
    wikipedia_link: "https://en.wikipedia.org/wiki/King_of_Coins",
  },
  {
    ...
    number: 1,
    card_links: "I The Magician",
    astrological_sign: "Gemini, Libra, Aquarius",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ace_of_Swords",
  },
  {
    ...
    number: 2,
    card_links: null,
    astrological_sign: "Moon in Libra",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Two_of_Swords",
  },
  {
    ...
    number: 3,
    card_links: null,
    astrological_sign: "Saturn in Libra",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Three_of_Swords",
  },
  {
    card_name: "Four of Swords",
    meanings: {
      upright:
        "The Four means taking a time out from projects, work, or relationships. You may need to step away from commitments to rest and rejuvenate. Self-care is key now.",
      reversed:
        "When reversed the card shows an enforced time out--so the message is to accept this and use it as an opportunity to think through your options.",
    },
    number: 4,
    card_links: null,
    astrological_sign: "Jupiter in Libra",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Four_of_Swords",
  },
  {
    ...
    number: 5,
    card_links: null,
    astrological_sign: "Venus in Aquarius",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Five_of_Swords",
  },
  {
    ...
    number: 6,
    card_links: null,
    astrological_sign: "Mercury in Aquarius",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Six_of_Swords",
  },
  {
    ...
    number: 7,
    card_links: null,
    astrological_sign: "Moon in Aquarius",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Seven_of_Swords",
  },
  {
    ...
    number: 8,
    card_links: null,
    astrological_sign: "Jupiter in Gemini",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Eight_of_Swords",
  },
  {
    ...
    number: 9,
    card_links: null,
    astrological_sign: "Mars in Gemini",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Nine_of_Swords",
  },
  {
    ...
    number: 10,
    card_links: "Death",
    astrological_sign: "Sun in Gemini",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ten_of_Swords",
  },
  {
    card_name: "Page of Swords",
    meanings: {
      upright:
        "As an influence the card brings necessary action. As a person the Page is an ambitious young person quick-witted and eager to take on a new challenge.",
      reversed:
        "When reversed, the card can indicate misinformation and a lack of focus.",
    },
    number: null,
    card_links: null,
    astrological_sign: "Sun in Gemini",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Page_of_Swords",
  },
  {
    ...
    number: null,
    card_links: "VII The Chariot",
    astrological_sign: "Taurus and Gemini",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Knight_of_Swords",
  },
  {
    card_name: "Queen of Swords",
    meanings: {
      upright:
        "As an influence: The card brings the gifts of perception and perspective. It's time for detached and logical thinking. Be strategic.",
      reversed:
        "Reversed the Queen can indicate someone who is cold-hearted and insensitive.",
    },
    number: null,
    card_links: "III The Empress",
    astrological_sign: "Virgo and Libra",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/Queen_of_Swords",
  },
  {
    ...
    number: null,
    card_links: "IV The Emperor",
    astrological_sign: "Capricorn and Aquarius",
    element: "Air",
    wikipedia_link: "https://en.wikipedia.org/wiki/King_of_Swords",
  },
  {
    card_name: "Ace of Wands",
    meanings: {
      upright:
        "A new passion begins. This ace brings fiery, dynamic energy, motivation and inspiration. This is an auspicious card for creativity.",
      reversed:
        "The reversed card can show creative blocks, overall delay, and a lack of energy.",
    },
    number: 1,
    card_links: "I The Magician",
    astrological_sign: "Aries, Leo, and Sagittarius",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ace_of_Wands_(tarot_card)",
  },
  {
    ...
    number: 2,
    card_links: null,
    astrological_sign: "Mars in Aries",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Two_of_Wands",
  },
  {
    ...
    number: 3,
    card_links: null,
    astrological_sign: "Sun in Aries",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Three_of_Wands",
  },
  {
    card_name: "Four of Wands",
    meanings: {
      upright:
        "This card brings happiness, celebration, and appreciation. This card has a focus on celebration that involves family.",
      reversed:
        "When reversed the card can reveal some delays to plans, disruptions, or a lack of harmony.",
    },
    number: 4,
    card_links: null,
    astrological_sign: "Venus in Aries",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Four_of_Wands",
  },
  {
    ...
    number: 5,
    card_links: null,
    astrological_sign: "Saturn in Leo",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Five_of_Wands",
  },
  {
    card_name: "Six of Wands",
    meanings: {
      upright:
        "This is a card of success representing victory and desires fulfilled.",
      reversed:
        "The reversed card can indicate a delay in success, or even failure.",
    },
    number: 6,
    card_links: null,
    astrological_sign: "Jupiter in Leo",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Six_of_Wands",
  },
  {
    ...
    number: 7,
    card_links: null,
    astrological_sign: "Mars in Leo",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Seven_of_Wands",
  },
  {
    ...
    number: 8,
    card_links: "VII The Chariot",
    astrological_sign: "Mercury in Sagittarius",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Eight_of_Wands",
  },
  {
    ...
    number: 9,
    card_links: null,
    astrological_sign: "Moon in Sagittarius",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Nine_of_Wands",
  },
  {
    card_name: "Ten of Wands",
    meanings: {
      upright:
        "The Ten of Wands represents overwhelm, it is a time to set limits and protect your energy.",
      reversed:
        "When reversed this card shows exhaustion and oppression and an inability to set boundaries, you may end up neglecting your own needs.",
    },
    number: 10,
    card_links: null,
    astrological_sign: "Saturn in Sagittarius",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Ten_of_Wands",
  },
  {
    ...
    astrological_sign: null,
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Page_of_Wands",
  },
  {
    card_name: "Knight of Wands",
    meanings: {
      upright:
        "As an influence this is a card of speed and inspiration. The Knight is driven and passionate. As a person the Knight is an unpredictable and spontaneous person who is wonderful company but needs lots of attention.",
      reversed:
        "The reverse card can represent someone who is headstrong and reckless.",
    },
    number: null,
    card_links: "VII The Chariot",
    astrological_sign: "Scorpio and Sagittarius",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Knight_of_Wands",
  },
  {
    ...
    number: null,
    card_links: "III The Empress",
    astrological_sign: "Pisces and Aries",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/Queen_of_Wands",
  },
  {
    ...
    number: null,
    card_links: "IV The Emperor",
    astrological_sign: "Cancer and Leo",
    element: "Fire",
    wikipedia_link: "https://en.wikipedia.org/wiki/King_of_Wands",
  },
];
